...
//     const existingChannel = await Channels.findAll({
//       where:{
...
//       const newChannel = await Channels.create({name:channel});
//       await createdMessage.addChannels(newChannel);
      
//     }else{
//       console.log('**outside if***');
//       await createdMessage.addChannels(existingChannel);
//     }
